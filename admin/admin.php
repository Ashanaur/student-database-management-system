...
<html lang="en">
    ...
    <body style="background:url('img/admin.jpg');background-size: cover;background-attachment: fixed;background-position: center; background-repeat: no-repeat;margin:0;padding:0; height: 700px;width:100%;"> 
        ...
        <div class='mt-5'>
            ...
            <div>
                <h2 class='text-center' style="font-family: 'Slabo 27px', serif;">Admin Login</h2>
            </div>
            <?php
                    if(isset($_GET['no'])){
                        $no = $_GET['no'];
                ...
                <form action="auth.php" method="post">
                    <input type="text" class='form-control mb-2' name='user' placeholder='Enter Username' required="">
                    <input type="password" class='form-control mb-2' name='pass' placeholder='Enter pass' required="">
