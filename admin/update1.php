...
<html lang="en">
    ...
    <body> 
        <div class="row" style="margin:0;padding:0;background: #502096;">
            <div class="col-md-12">
                <span><a style="text-decoration: none; font-family: 'Slabo 10px', serif;" href="#">Student Information  </a></span>
                <span style="float:right;"><a style="text-decoration: none; font-family: 'Slabo 10px', serif;" href="logout1.php?logout=3">Logout</a></span>
            </div> 
        </div>
        <div class="container">
            <div class="row mb-2">
                <div class="col-md-12 m-auto">
                    ...
                    <h3 class='text-center' style="font-family: 'Slabo 27px', serif;">Student Information Form</h3>
                    <hr>
                    <?php
